...
import com.trendyol.shipment.ShipmentSizeCalculatorService;
...
class BasketTest {
    ...
    @BeforeEach
    void setUp() {
        ShipmentSizeCalculatorService shipmentSizeCalculatorService = new ShipmentSizeCalculatorService();
        basket = new Basket(shipmentSizeCalculatorService);
    }
